...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Asset-Health-Framework-restapis\backendsvc\restapis\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Asset-Health-Framework-restapis\backendsvc\restapis\venv\Scripts\deactivate.nu'
